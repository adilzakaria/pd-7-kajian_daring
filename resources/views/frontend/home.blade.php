    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
      <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
          <h4 class="text-white mb-4 mt-5 mt-lg-0">Kajian Daring</h4>
          <h1 class="display-3 font-weight-bold text-white">
            Pendekatan Baru Untuk Pendidikan Anak Muda
          </h1>
          <p class="text-white mb-4">
          "Kajian Daring" adalah platform yang bertujuan untuk menyampaikan materi pendidikan secara online, 
          sehingga dapat diakses oleh siapa saja, di mana saja, dan kapan saja. 
          Dengan menggunakan teknologi terbaru, kami menyajikan berbagai topik yang disesuaikan dengan kebutuhan dan minat anak muda.
          </p>
